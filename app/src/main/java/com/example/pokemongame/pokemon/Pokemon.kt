...
data class Pokemon(
    ...
    constructor(
        ...
        experienceReward, attack, defense, maxHp, specialAttack, specialDefense, speed, name, moves, experience, level, hp,  species, frontSprite, backSprite, inTeam, ordering)
